    ...
    public function index(Request $request): View
    {
        $shops = collect([
            ...
            [
                ...
                'name' => 'Capitol City Electronics & Parts', 'rating' => 4.7, 'reviews' => 189, 'distance' => 'East Bhubaneswar (2.4 km away)',
            ...
            [
                ...
                'description' => 'Fastest glass repair in downtown Bhubaneswar. Dedicated express counter for iPhone, Samsung Galaxy and Pixel.',
        ...
        return view('pages.shops', [
            'city' => 'Bhubaneswar',
            'area' => 'Downtown Bhubaneswar',
            'category' => 'Electronics & Repairs',
            'subcategory' => 'Mobile & Laptop Repair',
            'avgResponseMins' => 4,
            'radiusKm' => 5,
            'activeFilters' => ['Bhubaneswar Downtown (5 km)', 'Verified merchant'],
            'establishmentTypes' => [
