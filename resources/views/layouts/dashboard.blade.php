...
<title>@yield('title', 'Dashboard — Thikana')</title>
  ...
  <div class="dash-header-inner">
    ...
    <div class="dash-header-center">
      <form class="dash-search" action="{{ route('shops.index') }}" method="get">
        ...
        <input type="text" name="q" value="{{ request('q') }}" placeholder="Search shops, rentals, products…" />
      </form>
    </div>
    <div class="dash-header-right">
      <a href="{{ route('home') }}" class="dash-header-link" title="Back to Thikana">
        <svg width="18" height="18" viewBox="0 0 20 20" fill="none"><path d="M10 2l8 7h-3v8h-4v-5H9v5H5v-8H2l8-7z" fill="currentColor"/></svg>
      </a>
