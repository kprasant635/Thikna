    ...
    <nav class="sidebar-nav">
        <div class="sidebar-section">
            ...
            <a href="{{ route('dashboard.referrals') }}"
                class="sidebar-link {{ request()->routeIs('dashboard.referrals') ? 'active' : '' }}">
            ...
            <a href="{{ route('business.create') }}"
                ...
                <span class="sidebar-icon">
                    <svg width="18" height="18" viewBox="0 0 20 20" fill="none">
                        <rect x="3" y="6" width="14" height="11" rx="2" fill="currentColor"
                            opacity=".4" />
        ...
        <div class="sidebar-section">
            ...
            <a href="{{ route('shops.index') }}"
                ...
                <span class="sidebar-icon">
                    <svg width="18" height="18" viewBox="0 0 20 20" fill="none">
                        <rect x="2" y="3" width="16" height="14" rx="3" fill="currentColor"
                            opacity=".4" />
            ...
            <a href="{{ route('rentals.index') }}"
                ...
                <span class="sidebar-icon">
                    <svg width="18" height="18" viewBox="0 0 20 20" fill="none">
                        <path d="M10 2l8 7h-3v8H5v-8H2l8-7z" fill="currentColor" opacity=".5" />
                        <rect x="8" y="12" width="4" height="5" rx="1" fill="currentColor" />
                    </svg>
                </span>
                Home Rentals
            </a>
        ...
        <div class="sidebar-section sidebar-bottom-section">
            <form method="POST" action="{{ route('logout') }}" style="margin:0;">
                ...
                <button type="submit" class="sidebar-link sidebar-logout-btn">
                    <span class="sidebar-icon">
                        <svg width="18" height="18" viewBox="0 0 20 20" fill="none">
                            <path d="M7 3H4a2 2 0 00-2 2v10a2 2 0 002 2h3" stroke="currentColor" stroke-width="1.5"
                                stroke-linecap="round" />
                            <path d="M13 14l4-4-4-4M17 10H8" stroke="currentColor" stroke-width="1.5"
