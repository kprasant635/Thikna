...
@section('title', ($property['title'] ?? 'Property Detail') . ' — Thikana Rentals')
  ...
  <div class="rshow-layout">
    ...
    <section class="rshow-main">
      ...
      <div class="rshow-section">
        ...
        <p>
          This {{ $property['title'] }} is a well-maintained unit in a prime Guwahati neighbourhood.
          Available for immediate occupancy with direct owner contact — no brokerage or hidden charges.
          The property is {{ strtolower(implode(', ', array_slice($property['tags'] ?? ['ready to move'], 0, 2))) }}.
        </p>
      </div>
    ...
    <aside class="rshow-sidebar">
      ...
      <div class="quote-box">
        ...
        <form method="post" action="{{ route('rentals.index') }}">
          ...
          <div class="field" style="margin-bottom:10px;">
            <label style="font-size:11.5px;font-weight:700;color:var(--ink-soft);display:block;margin-bottom:4px;">Full name</label>
            <input type="text" name="name" placeholder="e.g. Priya Das" style="width:100%;border:1.5px solid var(--line);border-radius:var(--radius-sm);padding:9px 11px;font-size:13.5px;font-family:'Inter',sans-serif;">
          </div>
          <div class="field" style="margin-bottom:10px;">
            <label style="font-size:11.5px;font-weight:700;color:var(--ink-soft);display:block;margin-bottom:4px;">Mobile number</label>
            <input type="tel" name="phone" placeholder="+91 98XXX XXXXX" style="width:100%;border:1.5px solid var(--line);border-radius:var(--radius-sm);padding:9px 11px;font-size:13.5px;font-family:'Inter',sans-serif;">
          </div>
          <div class="field" style="margin-bottom:14px;">
            <label style="font-size:11.5px;font-weight:700;color:var(--ink-soft);display:block;margin-bottom:4px;">Preferred visit date</label>
            <input type="date" name="date" style="width:100%;border:1.5px solid var(--line);border-radius:var(--radius-sm);padding:9px 11px;font-size:13.5px;font-family:'Inter',sans-serif;">
          </div>
          <button type="submit" class="btn btn-gold" style="display:block;width:100%;padding:13px;font-size:14px;">
      ...
      <div class="side-card" style="text-align:center;">
        ...
        <a class="btn btn-primary" href="tel:+919800000000" style="display:block;margin-top:10px;text-align:center;">
          📞 Call owner
        </a>
      ...
      <div class="side-card">
        <h4>💰 Cost summary</h4>
        <div class="hours-row"><span>Monthly rent</span><span><strong>₹{{ number_format($property['price']) }}</strong></span></div>
        <div class="hours-row"><span>Security deposit</span><span>{{ $property['deposit_label'] ?? '1 month' }}</span></div>
        <div class="hours-row"><span>Brokerage</span><span style="color:var(--green-bright);font-weight:700;">Zero ✓</span></div>
