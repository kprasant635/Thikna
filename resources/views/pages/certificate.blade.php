...
@section('content')
    <div class="cert-page-wrapper">
        ...
        <div class="cert-actions-bar">
            <div>
                <span style="font-weight: 700; font-size: 16px; color: var(--ink);">Official SkopX Certificate</span>
                <span style="font-size: 13px; color: var(--ink-soft); margin-left: 10px;">ID:
                    {{ $certificate->certificate_number }}</span>
            </div>
            <div style="display: flex; gap: 10px;">
                <button type="button" onclick="window.print()" class="btn btn-outline"
                    style="padding: 9px 18px; font-size: 13.5px; border-radius: var(--radius-sm); border: 1.5px solid var(--line);">
                    🖨️ Print Certificate
                </button>
                <a href="{{ route('benefits.index') }}" class="btn btn-primary"
                    style="padding: 9px 18px; font-size: 13.5px; border-radius: var(--radius-sm);">
        ...
        <div class="certificate-card">
            ...
            <div class="cert-body">
                ...
                <div class="cert-statement">
                    has successfully completed all mandatory short-video educational courses and fulfilled the educational
                    skill requirements for certified SkopX membership.
                </div>
            ...
            <div class="cert-footer">
                ...
                <div class="cert-sig-block">
                    <div class="cert-sig-line">SkopX Executive Board</div>
                    <div style="font-size: 12.5px; color: #718096; text-transform: uppercase; font-weight: 600;">Authorized
                        Signatory</div>
                </div>
            </div>
        </div>
